  ...
  columns: [
    {
      ...
      label: "Well name",
      width: "14%",
      field: ENUMS.FORM_FIELDS.WELL_INFO.WELL_NAME,
      defaultValue: "",
      required: true,
    },
    {
      ...
      label: "# of stages",
      width: "13%",
      field: ENUMS.FORM_FIELDS.WELL_INFO.NO_OF_STAGES,
      defaultValue: "",
      required: true,
      datatype: "integer",
    },
    {
      ...
      label: "Well API",
      width: "14%",
      field: ENUMS.FORM_FIELDS.WELL_INFO.WELL_API,
      defaultValue: "",
      required: true,
    },
    {
      ...
      label: "Formation",
      width: "14%",
      field: ENUMS.FORM_FIELDS.WELL_INFO.FORMATION,
      defaultValue: "",
      required: true,
    },
    {
      ...
      label: "Lat",
      width: "14%",
      field: ENUMS.FORM_FIELDS.WELL_INFO.LAT,
      defaultValue: "",
      required: true,
      datatype: "integer",
    },
    {
      ...
      label: "Long",
      width: "14%",
      field: ENUMS.FORM_FIELDS.WELL_INFO.LONG,
      defaultValue: "",
      required: true,
      datatype: "integer",
    },
...
const wellVolumeFormTableData = {
  columns: [
    { key: "1", label: "Type", width: "16%", field: ENUMS.FORM_FIELDS.WELL_VOLUME.TYPE, required: true },
    {
      ...
      label: "OD",
      width: "16%",
      field: ENUMS.FORM_FIELDS.WELL_VOLUME.OD,
      required: true,
      datatype: "integer",
    },
    {
      ...
      label: "Wt",
      width: "17%",
      field: ENUMS.FORM_FIELDS.WELL_VOLUME.WT,
      required: true,
      datatype: "integer",
    },
    {
      ...
      label: "ID",
      width: "17%",
      field: ENUMS.FORM_FIELDS.WELL_VOLUME.ID,
      required: true,
      datatype: "integer",
    },
    {
      ...
      label: "Depth [MD]",
      width: "17%",
      field: ENUMS.FORM_FIELDS.WELL_VOLUME.DEPTH_MD,
      required: true,
      datatype: "integer",
    },
    {
      ...
      label: "TOL",
      width: "17%",
      field: ENUMS.FORM_FIELDS.WELL_VOLUME.TOL,
      required: true,
      datatype: "integer",
    },
  ],
...
const wellVolumeEstimationsFormTableData = {
  columns: function (wellName) {
    return [{ key: "1", label: wellName, colSpan: "2" }];
  },
  grid: [
    {
      rows: [
  ...
  columns: [
    {
      ...
      width: "38%",
      field: ENUMS.FORM_FIELDS.CLIENT_INFO.CLIENT_USERNAME,
      required: true,
    },
    ...
    { key: "3", label: "Password", width: "27%", field: ENUMS.FORM_FIELDS.CLIENT_INFO.PASSWORD, required: true },
    {
      ...
      label: "",
      width: "8%",
      field: ENUMS.FORM_FIELDS.CLIENT_INFO.ACTION,
      defaultValue: "",
      className: "noborder",
    },
  ],
...
const crewInfoFormTableData = {
  columns: [
    { key: "1", label: "Field Role", width: "38%", field: ENUMS.FORM_FIELDS.CREW_INFO.FIELD_ROLE, required: true },
    ...
    { key: "3", label: "Shift", width: "27%", field: ENUMS.FORM_FIELDS.CREW_INFO.SHIFT, required: true },
    {
      ...
      label: "",
      width: "8%",
      field: ENUMS.FORM_FIELDS.CREW_INFO.ACTION,
      defaultValue: "",
      className: "noborder",
    },
  ],
  ...
  grid: [
    {
      rows: [
        ...
        {
          label: "Accumulator",
          field: ENUMS.FORM_FIELDS.EQUIPMENT.ACCUMULATOR_ID,
          required: true,
          datatype: "integer",
        },
        {
          label: "Hydrophones",
          field: ENUMS.FORM_FIELDS.EQUIPMENT.HYDROPHONES_ID,
          required: true,
          datatype: "integer",
        },
        {
          label: "PSI transducer",
          field: ENUMS.FORM_FIELDS.EQUIPMENT.PSI_TRANSDUCER_ID,
          required: true,
          datatype: "integer",
        },
